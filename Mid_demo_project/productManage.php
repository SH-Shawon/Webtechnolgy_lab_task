...
<body>
    ...
    <form action="productManageAction.php" method="post" novalidate>
        <div>
            <table>
                <td>
                    <fieldset>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="producttype" id="producttype"
                                        ...
                                        <?php echo isset($_SESSION['producttype_err_msg']) ? $_SESSION['producttype_err_msg'] : ""; ?>
                                </td>
                                <td>
                                    -
                                </td>
                                <td>
                                    <input type="text" name="productname" id="productname"
                                        ...
                                        <?php echo isset($_SESSION['productname_err_msg']) ? $_SESSION['productname_err_msg'] : ""; ?>
                                </td>
                                <td>
                                    -
                                </td>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <textarea placeholder="Product short description" id="description" name="description" rows="4"
                                        cols="50"></textarea>
                                        <br>
